        ...
        <div class="pagetitle col-lg-6 pt-2">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Yarn Category</li>
                </ol>
            </nav>
        </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Create Yarn Category</h5>

                        <!-- General Form Elements -->
                        <form action="{{ route('yarn_category.store')}}" method="post">
                            @csrf
                            <div class="row mb-3 pt-5">
                                ...
                                <input class="form-control" id="yarn_category" type="text" name="yarn_category"
                                        placeholder="Enter Yarn Category Name" required>
