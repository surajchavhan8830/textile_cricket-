...
class TournamentController extends Controller
{
    ...
    public function index_tournament(Request $request)
    {
        ...
        $tournament = Tournament::with('tournamenttype','user')->where('is_delete', 1)->orderBy('strat_date')->orderBy('id')->where('created_by', $user)->get();
    ...
    {
        $tournament = Tournament::with('tournamenttype','user')->where('status', 1)->where('is_delete', 1)->orderBy('strat_date', 'desc')->orderBy('id')->get();
