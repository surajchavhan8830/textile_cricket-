    ...
    public function player(Request $request)
    {
        ...
        $teams = TeamPlayer::join('team', 'team_player.team_id', '=', 'team.id')
            ...
            ->join('tournaments', function($join) {
                $join->on('team_player.tournament_id', '=', 'tournaments.id')
                ->where('tournaments.is_delete', '1')
                ->where('tournaments.status', '1');
            })
            //('tournaments', 'team_player.tournament_id', '=', 'tournaments.id')
        ...
        foreach ($teams as $team) {
            ...
            $matchs_new = MatchInformation::join('tournaments', function($join) {
                $join->on('match_information.tournament_id', '=', 'tournaments.id')
                ->where('tournaments.is_delete', '1')
                ->where('tournaments.status', '1');
            ...
            $query->where('team_1', $team->team_id)
                ...
                ->where('match_information.is_delete', 1)
